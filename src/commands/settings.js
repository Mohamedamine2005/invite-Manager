...
module.exports = {
    ...
    run: (client, message, args) => {
            ...
            if (!args[0]) {
                ...
                if (!args[1].startsWith("on" || "off")) return message.channel.send(
                    new MessageEmbed().setAuthor(message.author.tag, message.author.avatarURL({ dyanmic: true }))
                    .setDescription(
                ...
                if (!argment) return message.channel.send(
                    new MessageEmbed().setAuthor(message.author.tag, message.author.avatarURL({ dyanmic: true }))
                ...
                if (!channel || channel == null || undefined || NaN) return message.channel.send(
                    new MessageEmbed().setAuthor(message.author.tag, message.author.avatarURL({ dyanmic: true }))
                    .setDescription(
